...
#load model
model =load_model("model/v3_pred_cott_dis_1.h5")

print('@@ Model loaded')


def pred_cot_dieas(cott_plant):
  test_image = load_img(cott_plant, target_size = (150, 150)) # load image # change it to 500 if you use 9 hour trained model 
